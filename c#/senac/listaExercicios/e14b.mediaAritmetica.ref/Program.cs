...
namespace e14.mediaAritmetica
{
    ...
    {
        static void Inserir(ref string nome, ref int faltas, ref double nota1, ref double nota2, ref double nota3, ref double nota4, ref double media, ref string situacao)
        {
        ...
        static void Main(string[] args)
        {
            ...
            Inserir(ref nome, ref faltas, ref nota1, ref nota2, ref nota3, ref nota4, ref media, ref situacao);
